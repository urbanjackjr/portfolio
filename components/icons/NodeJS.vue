<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="589.827" height="361.238" version="1.2" viewBox="0 0 442.37 270.929">
        <defs>
            ...
            <linearGradient x1="-.348" x2="1.251" gradientTransform="rotate(116.114 53.1 202.97) scale(86.48)"
                gradientUnits="userSpaceOnUse">
                <stop offset=".3" stop-color="var(--background--600)" />
                <stop offset=".5" stop-color="var(--background--400)" />
                <stop offset=".8" stop-color="var(--background--300)" />
            </linearGradient>
            <clipPath>
                <path
            ...
            <linearGradient x1="-.456" x2=".582" gradientTransform="rotate(-36.46 550.846 -214.337) scale(132.798)"
                gradientUnits="userSpaceOnUse">
                <stop offset=".57" stop-color="var(--background--500)" />
                <stop offset=".72" stop-color="var(--background--300)" />
                <stop offset="1" stop-color="var(--background--100)" />
            </linearGradient>
            <clipPath>
                <path
            ...
            <linearGradient x1=".043" x2=".984" gradientTransform="translate(192.862 279.652) scale(97.417)"
                gradientUnits="userSpaceOnUse">
                <stop offset=".16" stop-color="var(--background--200)" />
                <stop offset=".38" stop-color="var(--background--100)" />
                <stop offset=".47" stop-color="var(--background--100)" />
                <stop offset=".7" stop-color="var(--background--300)" />
                <stop offset=".9" stop-color="var(--background--500)" />
            </linearGradient>
        </defs>
        <path fill="var(--background--100)"
        ...
        <path fill="var(--background--100)" fill-rule="evenodd"
