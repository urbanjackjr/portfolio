<template>
    <svg width="120.1" height="72.018" viewBox="0 0 120.1 72.018" xmlns="http://www.w3.org/2000/svg">
        <g stroke-linecap="round" fill-rule="evenodd" font-size="9pt" fill="var(--foreground)">
            <path
