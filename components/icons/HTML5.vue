<template>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 375 512">
        ...
        <g transform="translate(-68)">
            ...
            <path fill="var(--foreground--400)" d="M107.6 471l-33-370.4h362.8l-33 370.2L255.7 512" />
            <path fill="var(--foreground--200)" d="M256 480.5V131H404.3L376 447" />
            <path fill="var(--white-light)"
